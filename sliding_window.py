...
class sliding_window():
    ...
    def find_initial_lanes(self, binary_warped, plot = False):
    ...
    def find_next_line(self, binary_warped, left_fit, right_fit, plot = False):
...
class video_flow():
    ...
    def handle_image(self, img):
        ...
        ploty, left_fitx, right_fitx = window.find_initial_lanes(warped, plot=False)
